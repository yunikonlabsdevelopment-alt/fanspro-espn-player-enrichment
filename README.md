...
2. **Extract Data**: For each player:
   ...
   - Extracts 14 data points from player bio section
   - Handles missing data gracefully
3. **Track Changes**: Compares new data against existing Airtable data
4. **Update Status**: 
...
5. **Batch Updates**: Updates Airtable every 10 records to optimize API usage
6. **Detailed Logging**: Tracks specific fields changed in "ESPN Updates" column
